...
import { ArrowRight, Clock, Pencil, Trash, Eye } from "lucide-react";
...
export function ActivityTable({ data, loading, page, limit, onEdit, onDelete, isReadOnly = false }: ActivityTableProps) {
  return (
